...
REM Visual Studio Build Tools. This file is for compiling in Windows 64 bits.
REM
...
@call C:\msys64\msys2_shell.cmd -use-full-path -c "cd C:\mrv2-main && ./runmeq.sh -t package; exec bash"
